                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Slidable(
                              ...
                              child: Card(child: ListTile(title: Text(ingrediente.produto.nome), subtitle: Text('${ingrediente.quantidade} ${ingrediente.unidade}'), trailing: Text(MoneyFormatter.formatReal(ingrediente.custoTotal), style: const TextStyle(fontWeight: FontWeight.bold)))),
                            );
                          },
                        ),
                      const SizedBox(height: 16),
      ...
      builder:
          (context) => AlertDialog(
            ...
            actions: [
              ...
              TextButton(
                onPressed: () {
                  if (quantidadeController.text.isEmpty || double.tryParse(quantidadeController.text) == null) {
                  ...
                  if (produtoSelecionado != null) {
                    ...
                    final novoIngrediente = Ingrediente(id: DateTime.now().millisecondsSinceEpoch.toString(), produto: produtoSelecionado!, quantidade: quantidade, unidade: unidadeSelecionada);
  ...
  void _salvar() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (_isEdicao && _receitaOriginal != null) {
        final receitaAtualizada = Receita(id: _receitaOriginal!.id, nome: nome, ingredientes: _ingredientes, percentualGastos: _percentualGastos, percentualMaoDeObra: _percentualMaoDeObra, rendimento: rendimento, unidadeRendimento: _unidadeRendimento);

        controller.atualizarReceita(receitaAtualizada);
      } else {
        controller.salvarReceita(nome: nome, ingredientes: _ingredientes, percentualGastos: _percentualGastos, percentualMaoDeObra: _percentualMaoDeObra, rendimento: rendimento, unidadeRendimento: _unidadeRendimento);
      }
